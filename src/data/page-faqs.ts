...
export const pageFAQs: Record<string, PageFAQ[]> = {
  ...
  homepage: [
    ...
    },
    {
      ...
      answer:
        'Dr. Jan Duffy hosts weekend open houses across Summerlin, Henderson, and North Las Vegas, with follow-up on every guest. Compare square footage, HVAC age, and named school campuses on each listing. The office phone is in the footer.',
    },
    {
  ...
  'seller-services': [
    ...
    },
    {
      ...
      answer:
        'We use professional photography, virtual tours, the public listing, social media marketing, open houses, and targeted advertising to reach qualified buyers.',
    },
    {
  ...
  summerlin: [
    {
      question: 'What amenities are in Summerlin?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Summerlin is in the Clark County School District. Large parts of 89135–89138 are served by Palo Verde High School and West Career and Technical Academy. Confirm the campus printed on each listing. Dr. Jan Duffy can map open houses by school zone without ranking neighborhoods as “good” or “bad.”',
    },
  ],
  ...
  'north-las-vegas': [
    {
      ...
      answer:
        'North Las Vegas listings use zip codes 89030, 89031, 89032, 89081, 89084, and 89086. Skye Canyon (89084) is newer construction; Centennial Hills (89031) is 1990s–2000s housing near I-215 shopping. Compare square footage, HVAC age, HOA dues, and the named campus on each listing. The office phone for Dr. Jan Duffy is in the footer.',
    },
    {
    ...
    {
      question: 'What price ranges appear on North Las Vegas listings?',
      answer:
        'Many North Las Vegas listings start around $250,000–$350,000, with mid-range homes about $350,000–$500,000 and some Skye Canyon (89084) homes above $600,000. Confirm recent sales of similar homes before you write an offer.',
    },
    {
      question: 'Which named schools serve North Las Vegas?',
      answer:
        'Clark County School District campuses vary by street, including newer campuses in Skye Canyon (89084) and Centennial Hills (89031). Confirm the elementary, middle, and high school printed on the listing. Open House Marketplace does not rank school quality.',
    },
  ],
  ...
  'spring-valley': [
    ...
    },
    {
      ...
      answer:
        'Most Spring Valley tracts from the 1970s–1990s list 1,400–2,400 sq ft on 5,000–8,000 sq ft lots. Confirm HVAC age, roof year, and HOA dues (many streets have none) on the listing before you tour.',
    },
    {
  ...
  enterprise: [
    ...
    },
    {
      ...
      answer:
        'Desert Oasis High School and Liberty High School appear on many Enterprise listings. Confirm the elementary campus on each listing rather than using a ranking.',
    },
  ],
  ...
  'green-valley': [
    ...
    },
    {
      ...
      answer:
        'Coronado High School serves a large part of Green Valley (89012, 89014). Confirm the elementary and middle campus printed on each listing. Dr. Jan Duffy can filter weekend open houses by that campus name.',
    },
    {
  ...
  'this-weekend': [
    {
      ...
      answer:
        'Use our this weekend page to browse open houses scheduled for Saturday and Sunday across Las Vegas Valley. You can filter by neighborhood including Summerlin (zip codes 89134-89144), Henderson (89002-89015), North Las Vegas (89030-89086), Spring Valley (89103-89147), or search by price range, bedrooms, and other criteria. The home search shows current listings of weekend open houses throughout Las Vegas Valley zip codes 89103-89148, 89002-89074, and 89030-89086. Dr. Jan Duffy, as an Open House Expert, hosts numerous weekend open houses and can help you find properties matching your criteria.',
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, weekend open houses in Las Vegas Valley typically see higher attendance than weekday showings, especially on Saturdays. This is common throughout Las Vegas neighborhoods in zip codes 89103-89148 (Las Vegas), 89002-89074 (Henderson), and 89030-89086 (North Las Vegas). Weekend open houses are popular because most people have free time, buyers often set aside weekend time for property searching. Popular areas like Summerlin (89134-89144) and Henderson's Green Valley (89012, 89014) may see particularly busy weekend open houses. Arriving early can help you view properties before crowds, and scheduling private showings during the week is also an option.",
    },
    {
  ...
  search: [
    {
      ...
      answer:
        'Use our advanced search tool to find homes throughout Las Vegas Valley. You can filter by price range, location (including specific zip codes like 89134-89144 for Summerlin, 89002-89015 for Henderson, 89030-89086 for North Las Vegas), number of bedrooms and bathrooms, property type, and more. The home search shows current listings across all Las Vegas Valley neighborhoods in zip codes 89103-89148, 89002-89074, and 89030-89086. You can search by specific neighborhoods like The Ridges, Green Valley Ranch, Anthem, or Skye Canyon, or browse broader areas. Dr. Jan Duffy can help you refine your search criteria and find properties matching your needs.',
    },
    {
      question: 'Can I save my search criteria?',
      answer:
        "Yes, you can save your search criteria and set up alerts for new listings matching your preferences. Save searches for specific areas like Summerlin (zip codes 89134-89144), Henderson (89002-89015), or North Las Vegas (89030-89086), and receive notifications when new properties become available. Our search tool allows you to save multiple searches for different neighborhoods, price ranges, or property types. Working with Dr. Jan Duffy also gives you access to alerts when a matching home is listed and personalized property recommendations based on your saved criteria. She can set up custom searches for neighborhoods from Lake Las Vegas to Centennial Hills, ensuring you don't miss opportunities.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Our search results are updated in real-time as homes are listed, providing the most current listings available. New properties are added as soon as they're listed, and sold properties are removed immediately. This ensures you see accurate, up-to-date information for all Las Vegas Valley neighborhoods in zip codes 89103-89148, 89002-89074, and 89030-89086. However, working directly with Dr. Jan Duffy gives you even earlier access when a home is first listed, sometimes seeing listings before they're widely publicized. She can provide immediate notifications for new listings matching your criteria in neighborhoods from Summerlin to Henderson to North Las Vegas.",
    },
    {
      question: 'Can I search for open houses specifically?',
      answer:
        'Yes, our search tool allows you to filter specifically for properties with scheduled open houses. You can search for open houses by date (including this weekend), neighborhood (Summerlin 89134-89144, Henderson 89002-89015, etc.), price range, and other criteria. This makes it easy to plan your weekend property viewing schedule across Las Vegas Valley. Dr. Jan Duffy, as an Open House Expert, hosts numerous open houses throughout Las Vegas neighborhoods and can help you find open houses in areas of interest, whether the search is The Ridges or North Las Vegas (89030-89086). Compare list price, square footage, and HOA dues on each sheet.',
    },
  ],
  ...
  'open-houses-for-sale': [
    ...
    },
    {
      ...
      answer:
        'Open house experiences vary by price range: **Under $400K**: May see more visitors, faster-paced viewing, competitive situations, and properties needing some updates. **$400K-$600K**: Balanced traffic, good variety of options, 1990s–2000s housing, and turn-key or updated properties. **$600K-$800K**: Moderate traffic, higher-quality finishes, premium neighborhoods like Summerlin (89134-89144) or Henderson (89002-89015), and well-maintained properties. **Over $800K**: More exclusive viewings, luxury features and finishes, premium communities like The Ridges or Lake Las Vegas, and personalized attention. Dr. Jan Duffy adapts her open house presentation to each price range, ensuring all visitors receive appropriate attention and information, at every list price.',
    },
  ],
